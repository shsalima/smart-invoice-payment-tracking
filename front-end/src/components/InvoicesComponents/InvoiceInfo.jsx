    ...
    return (
        <div className="card">
            <div className="header-info-card">
                ...
                <span
                    className={`badge badge-${oneInvoiceData.status?.toLowerCase()}`}
                >
            ...
            <div className="grid-status">
                ...
                <div
                    className={`amount-status ${
                        oneInvoiceData.paid === oneInvoiceData.amount
                            ? "green"
                            : "red"
                    }`}
                >
            ...
            <div className="progress-bar">
                <div
                    ...
                    style={{
                        width: `${
                            (oneInvoiceData.paid / oneInvoiceData.amount) * 100
                        }%`,
                    }}
                ></div>
            </div>
